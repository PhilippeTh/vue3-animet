  ...
  methods: {
    ...
    setHeaderFooterPreviewHeight(headerH, footerW, footerH, mapW) {
      const percentageFooter =
        (footerH / this.currentAspect[this.currentResolution].height) *
        100;
      const invPercentageFooter = 100.0 - percentageFooter;
      const percentageHeader =
        (headerH / this.currentAspect[this.currentResolution].height) *
        100;
      ...
      const percentageWidthDate =
        (dateWidth / this.currentAspect[this.currentResolution].width) *
        100;
      const percentageHeightDate =
        (dateHeight / this.currentAspect[this.currentResolution].height) *
        100;
