<template>
  ...
  >
    <div class="controller-padding" v-if="mapTimeSettings.Step !== null">
      <div v-if="screenWidth >= 565">
        ...
        >
          <v-icon v-if="!collapsedControls" large> mdi-chevron-down </v-icon>
          <div
            v-else-if="
              mapTimeSettings.Step === 'P1M' || mapTimeSettings.Step === 'P1Y'
            "
          >
